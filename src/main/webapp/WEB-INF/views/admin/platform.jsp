                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="well well-sm">
                                The performance result is based on different platform. 
                                <shiro:hasRole name="admin"> 
                                <a href="${ctx}/admin/platform/create" class="btn btn-info btn-xs pull-right ">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${platforms}" var="platform">
                                        <tr>
                                            <td class="center"><a href="${ctx}/admin/platform/edit/${platform.id}">${platform.name}</a></td>
                                            <td class="center">
                                               <c:choose>
                                                    <c:when test="${platform.status eq 'active'}">
                                                        <span class="label-success label label-default">Active</span>
                                                    </c:when>
                                                    <c:when test="${platform.status eq 'inactive'}">
                                                        <span class="label label-default">Inactive</span>
                                                    </c:when>
                                                    <c:when test="${platform.status eq 'pending'}">
                                                        <span class="label-warning label label-default">Pending</span>
                                                    </c:when>
                                                    <c:when test="${platform.status eq 'obsolete'}">
                                            ...
                                            <shiro:hasRole name="admin">
                                                <td class="center"><a class="btn btn-danger btn-xs"
                                                    href="${ctx}/admin/platform/delete/${platform.id}"> <i
